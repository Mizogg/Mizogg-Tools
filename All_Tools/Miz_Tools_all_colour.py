...
# -*- coding: utf-8 -*-
'''
Made by Mizogg Tools to Help Look for Bitcoin and ETH. Good Luck and Happy Hunting Miz_Tools_all_colour.py Version 1 Donations 3GCypcW8LWzNfJEsTvcFwUny3ygPzpTfL4
 28 Bitcoin & ETH Tools
...
''' + colour_green + '''
    ...
    *    Option 28.Mnemonic Words Generator Random Choice [Offline]      = 28   *'''+  colour_reset +'''
    *                                                                           *
    *               Donations 3GCypcW8LWzNfJEsTvcFwUny3ygPzpTfL4                *
    ******** Main Menu Mizogg's Tools Using Bit Library made in Python **********

Type You Choice Here Enter 1-28 :  '''
...
while True:
    ...
    ************************* Mnemonic Words 12/15/18/21/24 tool *************************
        ...
        print(colour_red + "WRONG NUMBER!!! MUST CHOSE 1 - 28 " + colour_reset)
