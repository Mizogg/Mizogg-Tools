...
# -*- coding: utf-8 -*-
'''
Made by Mizogg Tools to Help Look for Bitcoin and ETH. Good Luck and Happy Hunting Miz_Tools_all.py Version 1 Donations 3GCypcW8LWzNfJEsTvcFwUny3ygPzpTfL4
...
while True:
    ...
    ************************* Mnemonic Words 12/15/18/21/24 tool *************************
    ...
    if start ==28:
        ...
        print("WRONG NUMBER!!! MUST CHOSE 1 - 28 ")