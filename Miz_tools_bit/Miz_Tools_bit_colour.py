# -*- coding: utf-8 -*-
'''
Made by Mizogg Tools to Help Look for Bitcoin. Good Luck and Happy Hunting Miz_Tools_bit_colour.py Version 1 Donations 3GCypcW8LWzNfJEsTvcFwUny3ygPzpTfL4
 22 Bitcoin Tools
Using Bit Library made in Python
https://mizogg.co.uk
'''
import requests, codecs, hashlib, ecdsa, bip32utils, binascii, sys, time, random, itertools, atexit
...
''' + colour_green + '''
    ...
    ******** Main Menu Mizogg's Tools Using Bit Library made in Python **********'''+  colour_reset +'''
...
while True:
    ...
    *                                                                                                   *
    ************************* Retrieve ECDSA signature R,S,Z rawtx or txid tool *************************''' + colour_reset + '''
Type 1-2 to Start        '''
        ...
        if startrsz == 1:
            ...
            print(colour_red + "WRONG NUMBER!!! MUST CHOSE 1 - 2 " + colour_reset)
            break
    ...
    *********************** Bitcoin Addresses from file to Public Key Tool ********************
        ...
        print(colour_red + "WRONG NUMBER!!! MUST CHOSE 1 - 22 " + colour_reset)
        break